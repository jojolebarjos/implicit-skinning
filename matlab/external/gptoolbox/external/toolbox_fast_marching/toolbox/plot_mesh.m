...
if isempty(face_vertex_color)
    h = patch('vertices',vertex,'faces',face,'facecolor',[face_color face_color face_color],'edgecolor',[edge_color edge_color edge_color], 'FaceAlpha', options.alpha);
else
    ...
    h = patch('vertices',vertex,'faces',face,'FaceVertexCData',face_vertex_color, 'FaceColor',shading_type, 'EdgeColor', 'none', 'FaceAlpha', options.alpha);
end
colormap gray(256);
lighting phong;
camlight infinite; 
